...
# Load datasets (Make sure the file paths are correct relative to your deployment)
...
# Load model (Ensure the model file is correctly placed in the deployed environment)
...
def get_db_connection():
    connection = mysql.connector.connect(
        ...
        database='opdmsis'  # Replace with your database name
    )
    return connection

# Helper function to fetch details from CSV
def helper(dis):
...
# Define symptom-to-index mapping
...
# List of diseases (ID mapping)
diseases_list = {15: 'Fungal infection', 4: 'Allergy', 16: 'GERD', 9: 'Chronic cholestasis', 14: 'Drug Reaction', 33: 'Peptic ulcer diseae', 1: 'AIDS', 12: 'Diabetes ', 17: 'Gastroenteritis', 6: 'Bronchial Asthma', 23: 'Hypertension ', 30: 'Migraine', 7: 'Cervical spondylosis', 32: 'Paralysis (brain hemorrhage)', 28: 'Jaundice', 29: 'Malaria', 8: 'Chicken pox', 11: 'Dengue', 37: 'Typhoid', 40: 'hepatitis A', 19: 'Hepatitis B', 20: 'Hepatitis C', 21: 'Hepatitis D', 22: 'Hepatitis E', 3: 'Alcoholic hepatitis', 36: 'Tuberculosis', 10: 'Common Cold', 34: 'Pneumonia', 13: 'Dimorphic hemmorhoids(piles)', 18: 'Heart attack', 39: 'Varicose veins', 26: 'Hypothyroidism', 24: 'Hyperthyroidism', 25: 'Hypoglycemia', 31: 'Osteoarthristis', 2: 'Arthritis', 27: '(vertigo) Paroymsal  Positional Vertigo', 5: 'Acne', 35: 'Psoriasis', 38: 'Impetigo'}

@app.route('/predict', methods=['POST'])
def predict():
    try:
        # Get symptoms from the request form data (POST)
        ...
        input_data = np.zeros(len(symptoms_dict))  # Initialize array of 0s
        ...
        # Fetch the details (description, precautions, medications, diet, workout)
